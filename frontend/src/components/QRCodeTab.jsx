...
const ProfileModal = ({ profileForm, setProfileForm, handlePhotoUpload, handleDocumentUpload, handleProfileSubmit, saveLocalProfile, calculateQRCodeColor, getDaysSinceUpload }) => {
  return (
    ...
    <div className="p-4 border border-red-400 rounded-xl bg-red-50 text-center">
      ...
      {!showPayment ? (
        ...
        <>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-lg border-2 border-blue-300 shadow-md">
            <div className="text-center mb-4">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-1">Secure Payment Processing</h3>
              <p className="text-sm text-gray-600">You'll be redirected to our secure checkout page</p>
            </div>
            ...
            <div className="mt-4 flex items-center justify-center text-xs text-gray-500">
              ...
              Secure 256-bit SSL encryption • PayPal protected
            </div>
          </div>
        </>
      )}
